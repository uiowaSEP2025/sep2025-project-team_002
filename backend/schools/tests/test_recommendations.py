...
class TestRecommendations:
    ...
    def create_school(self):
        def _create_school(name, mbb=False, wbb=False, fb=False, **kwargs):
            ...
            return Schools.objects.create(
                school_name=name, mbb=mbb, wbb=wbb, fb=fb, **defaults
            )
    ...
    def create_preferences(self, create_user):
        def _create_preferences(user=None, sport="mbb", **kwargs):
            ...
            return Preferences.objects.create(user=user, sport=sport, **defaults)
    ...
    def test_get_recommendations_with_preferences(
        self, api_client, create_user, create_school, create_review, create_preferences
    ):
        ...
        school_ranks = {
            school["school"]["school_name"]: i for i, school in enumerate(response.data)
        }
    ...
    def test_get_recommendations_no_matching_schools(
        self, api_client, create_user, create_preferences
    ):
