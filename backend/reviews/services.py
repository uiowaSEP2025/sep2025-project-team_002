            ...
            for coach in coach_data:
                if self._normalize_name(coach["person"]) == search_name:
                    ...
                    if normalized_school and history:
                        ...
                        tenure_schools = [self._normalize_name(school.split('@')[1]) if '@' in school else self._normalize_name(school) 
                                        for school in history.split('\n')]
                        
                        if not any(normalized_school in school for school in tenure_schools):
