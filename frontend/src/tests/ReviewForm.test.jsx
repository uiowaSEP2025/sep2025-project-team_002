...
// await waitFor(() => {
//   const button = screen.getByText("Submit Your Review");
...
//
//     // Find all the rating buttons within the rating component
//     const ratingButtons = within(ratingComponent).getAllByRole("button");
//
//     // Click the button corresponding to the desired rating value
//     fireEvent.click(ratingButtons[field.value - 1]); // Ratings are 1-based, buttons are 0-based
//   });
//
...
//   });
//
//   // Debug the DOM before submission
//   screen.debug();
//
//   // Click submit
//   fireEvent.click(screen.getByText("Submit Review"));
